...
## [2026-05-23] ingest | Batch: 6 compute/hardware podcasts (Reiner Pope x2, Jane Street, Etched, Gavin Baker Watts/Wafers, Eric Jang AlphaGo)

Ingested 6 dense technical episodes under raw/podcasts/. Created 6 source pages: [[wiki/sources/reiner-pope-training-serving]], [[wiki/sources/reiner-pope-chip-design]], [[wiki/sources/jane-street-gpus-trading]], [[wiki/sources/harvard-dropouts-nvidia-challenger]] (Etched), [[wiki/sources/gavin-baker-watts-wafers]], [[wiki/sources/eric-jang-alphago-selfplay]]. New entities: [[wiki/entities/reiner-pope]], [[wiki/entities/jane-street]], [[wiki/entities/etched]], [[wiki/entities/eric-jang]]. New concepts: [[wiki/concepts/inference-economics]], [[wiki/concepts/asic-vs-gpu]], [[wiki/concepts/self-play-rl]]. Updated entities [[wiki/entities/gavin-baker]], [[wiki/entities/nvidia]], [[wiki/entities/anthropic]], [[wiki/entities/openai]], [[wiki/entities/google]] and concept [[wiki/concepts/scaling-laws]] with new Appearances/cross-links. Index 122→135 pages. Cross-linked heavily to existing compute/hardware pages (dylan-patel-*, jensen-huang-nvidia-moat, gavin-baker-gpu-economics). Skipped "Jensen Huang – Will Nvidia's moat persist? 1.md" as a confirmed duplicate of already-ingested [[wiki/sources/jensen-huang-nvidia-moat]]. Tensions flagged in-page: Reiner's HBM-surplus claim vs Dylan's "50% of CapEx on memory" (memory wall) — both true (bandwidth vs capacity); Gavin Baker's bitter-lesson-may-break (via ASI) vs the standard scaling thesis.

## [2026-05-23] ingest | Jonathan Ross (Groq / $20B NVIDIA deal) + Karan Goel (State Space Models / Cartesia)

Ingested 2 podcasts under raw/podcasts/. Created 2 source pages: [[wiki/sources/jonathan-ross-groq]], [[wiki/sources/karan-goel-state-space-models]]. New entities: [[wiki/entities/groq]], [[wiki/entities/jonathan-ross]], [[wiki/entities/cartesia]], [[wiki/entities/karan-goel]]. New concept: [[wiki/concepts/state-space-models]] (architecture-side attack on inference cost, complementing asic-vs-gpu / inference-economics). Updated entities [[wiki/entities/nvidia]] and [[wiki/entities/jensen-huang]] and concepts [[wiki/concepts/inference-economics]], [[wiki/concepts/asic-vs-gpu]] with new Appearances/cross-links. Index 135→142 pages.

Contradiction flagged & corrected: existing pages ([[wiki/entities/nvidia]], [[wiki/entities/jensen-huang]], [[wiki/sources/jensen-huang-nvidia-moat]]) described NVIDIA *acquiring* Groq. Per Jonathan Ross's own account, the ~$20B deal was a licensing/partnership with Ross joining NVIDIA as an executive — Groq the company persisted. Corrected wording on nvidia/jensen-huang pages; noted in-page on the groq entity and jonathan-ross-groq source. Cross-linked heavily to compute/hardware pages (reiner-pope-*, etched, gavin-baker-*, jensen-huang-nvidia-moat, tokenomics). Karan Goel talk is from Oct 2024 — noted 2026 data gap for SSM adoption follow-up.
